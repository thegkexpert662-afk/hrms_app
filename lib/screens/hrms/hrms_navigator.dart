...
class _HrmsNavigatorState extends State<HrmsNavigator> {
  ...
  Widget page(){final s=widget.service;switch(selected){case 0:return DashboardScreen(service:s);case 1:return EmployeeScreen(service:s);case 2:return LifecycleScreen(service:s);case 3:return AttendanceScreen(service:s);case 4:return LeaveScreen(service:s);case 5:return PayrollScreen(service:s);case 6:return DepartmentScreen(service:s);case 7:return ShiftScreen(service:s);case 8:return PerformanceScreen(service:s);case 9:return DocumentsScreen(service:s);case 10:return RecruitmentScreen(service:s);case 11:return EssScreen(service:s);case 12:return ExpenseScreen(service:s);case 13:return AssetsScreen(service:s);case 14:return NotificationsScreen(service:s);case 15:return CommunicationScreen(service:s);case 16:return ReportsScreen(service:s);case 17:return AdminScreen(service:s);case 18:return SettingsScreen(service:s);default:return AdvancedAttendanceScreen(service:s);}}
