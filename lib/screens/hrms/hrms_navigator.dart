...
class _HrmsNavigatorState extends State<HrmsNavigator> {
  ...
  final titles = const [
    ...
    'Document Management', 'Recruitment', 'Employee Self Service', 'Expense Management',
  ...
  final icons = const [
    ...
    Icons.person, Icons.receipt_long, Icons.devices, Icons.notifications, Icons.campaign,
    Icons.analytics, Icons.security, Icons.settings, Icons.gps_fixed,
  ];
